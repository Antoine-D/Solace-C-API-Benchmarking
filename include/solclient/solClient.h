...
*
* Copyright 2007-2015 Solace Systems, Inc. All rights reserved.
*
...
*     <td width="300"> The client could not log into the appliance (bad username or password).</td>
*     <td width="300"> All 401 and 404 error codes from appliance                  </td> 
* </tr>
* <tr>
...
*     <td width="300"> An attempt was made to bind to a shutdown Guaranteed Delivery Topic Endpoint.</td>
*     <td width="300"> 503 Durable Topic Endpoint Shutdown                        </td> 
* </tr>
* <tr>
...
#define solClient_log(level, ...) \
    {if (level <= _solClient_log_appFilterLevel_g) { \
         _solClient_log_output(SOLCLIENT_LOG_CATEGORY_APP, level, __VA_ARGS__);}}
...
#define solClient_log_va_list(level, format_p, ap) \
    {if (level <= _solClient_log_appFilterLevel_g) { \
         _solClient_log_output_va_list(SOLCLIENT_LOG_CATEGORY_APP, level, format_p, ap);}}
/*@}*/
#endif
 ...
 * @li ::SOLCLIENT_SUBCODE_TIMEOUT - Neither a commit nor a rollback response occurred. The API retransmits the commit 
 * request sent three (3) times, with a timeout of ::SOLCLIENT_TRANSACTEDSESSION_PROP_REQUESTREPLY_TIMEOUT_MS between
 * each attempt. The call to solClient_transactedSession_commit() fails after the last retry times out.
